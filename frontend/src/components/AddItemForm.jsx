...
function AddItemForm() {
    ...
    const collections = useSelector(selectCollections).filter((collection) => collection.ownerId === currentUserId)
        ...
        <form className="form-grid" onSubmit={submitForm}>
            ...
            <label>
                ...
                <select value={form.collectionId} onChange={(event) => updateField('collectionId', event.target.value)}>
                    ...
                    {collections.map((collection) => <option key={collection.id}
            ...
            <div className="form-grid__wide upload-preview">
                ...
                <p>Если фото не будет загружено, то вместо него будет установлена заглушка</p>
            </div>
            ...
            <div className="form-grid__actions">
                <Button variant="primary" type="submit">Сохранить предмет</Button>
            </div>
        </form>
    )
}
